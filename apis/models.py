...
class SubCategory(models.Model):
    ...
    image = VersatileImageField(
        blank=True, null=True, upload_to="Subcategory/", ppoi_field="image_ppoi"
    )
...
class SubSubCategory(models.Model):
    ...
    order = models.IntegerField()
    image = VersatileImageField(
        blank=True, null=True, upload_to="SubSubcategory/", ppoi_field="image_ppoi"
    )
    image_ppoi = PPOIField()
    name = models.CharField(max_length=200)
...
class Products(models.Model):
    ...
    order = models.IntegerField()
    image = VersatileImageField(
        blank=True, null=True, upload_to="Products/", ppoi_field="image_ppoi"
    )
    image_ppoi = PPOIField()
...
class Options(models.Model):
    product = models.ForeignKey(
        Products, related_name="options", on_delete=models.CASCADE
    )
    order = models.IntegerField()
    image_one = VersatileImageField(
        blank=True, null=True, upload_to="Options/", ppoi_field="image_one_ppoi"
    )
    image_one_ppoi = PPOIField()
    image_two = VersatileImageField(
        blank=True, null=True, upload_to="Options/", ppoi_field="image_two_ppoi"
    )
    image_two_ppoi = PPOIField()
    image_three = VersatileImageField(
        blank=True, null=True, upload_to="Options/", ppoi_field="image_three_ppoi"
    )
...
class Offer(models.Model):
    product = models.OneToOneField(
        Products, related_name="offers", on_delete=models.CASCADE
    )
...
class WishList(models.Model):
    ...
    product = models.ForeignKey(
        Products, related_name="users", on_delete=models.CASCADE
    )
...
class cart(models.Model):
    ...
    date = models.DateTimeField(auto_now=True)
    is_placed = models.BooleanField(default=False, verbose_name="Cart Status")


class Order(models.Model):
    product = models.ForeignKey(
        Products, related_name="orderedproducts", on_delete=models.CASCADE
    )
    selectedsize = models.ForeignKey(
        Sizes,
        related_name="orderedsize",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    selectedcolor = models.ForeignKey(
        Options,
        related_name="orderedcolor",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    quantity = models.IntegerField()
    parentcart = models.ForeignKey(
    ...
    has_paid = models.BooleanField(
        default=False, verbose_name="Payment Status", null=True, blank=True
    )
